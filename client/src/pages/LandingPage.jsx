...
export default function LandingPage({ setUser }) {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] text-slate-basalt selection:bg-nepal-red selection:text-white font-sans overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6 text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-100 border border-slate-200 text-slate-700 text-xs font-semibold uppercase tracking-wider rounded-sm animate-fade-in-up">
                <Landmark className="w-3.5 h-3.5 text-nepal-red" />
                NEPAL CIVIC INTEGRITY PORTAL
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-extrabold text-pagoda-wood leading-tight tracking-tight animate-fade-in-up [animation-fill-mode:backwards]">
                Nepal's Civic Accountability Platform.
              </h1>
              
              <p className="text-lg text-slate-basalt/80 font-normal leading-relaxed max-w-xl animate-fade-in-up opacity-0 [animation-fill-mode:forwards]" style={{ animationDelay: '150ms' }}>
              ...
              {/* Powerful Search Bar */}
              <div className="relative max-w-lg transition-all duration-300 focus-within:scale-[1.01] animate-fade-in-up opacity-0 [animation-fill-mode:forwards]" style={{ animationDelay: '300ms' }}>
                <div className="flex items-center border-2 border-pagoda-wood rounded bg-white shadow-sm overflow-hidden focus-within:ring-2 focus-within:ring-nepal-red/20 focus-within:border-nepal-red transition-all duration-300">
                  <div className="pl-3">
                ...
                {showSuggestions && filteredSuggestions.length > 0 && (
                  <div className="absolute left-0 right-0 mt-1 bg-white border border-slate-200 rounded shadow-lg z-50 overflow-hidden animate-fade-in-up duration-200">
                    {filteredSuggestions.map((s, idx) => (
                      <button
                        key={idx}
                        onClick={() => handleSelectSuggestion(s)}
                        className="w-full text-left px-4 py-3 hover:bg-slate-50 text-xs font-semibold flex justify-between items-center border-b border-slate-100 last:border-0 transition-colors"
                      >
              ...
              {/* Quick Actions Grid */}
              <div className="space-y-3 pt-2 animate-fade-in-up opacity-0 [animation-fill-mode:forwards]" style={{ animationDelay: '450ms' }}>
                <div className="text-xs uppercase tracking-widest font-bold text-slate-400">Quick Actions</div>
                <div className="flex flex-wrap gap-2.5">
                  <Link to="/directory" className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 border border-slate-200 hover:border-slate-300 text-xs font-semibold rounded text-slate-700 transition-all hover:scale-[1.03]">
                    View Election Results
                  </Link>
                  <Link to="/map" className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 border border-slate-200 hover:border-slate-300 text-xs font-semibold rounded text-slate-700 transition-all hover:scale-[1.03]">
                    Explore Nepal Map
                  </Link>
                  <Link to="/promises" className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 border border-slate-200 hover:border-slate-300 text-xs font-semibold rounded text-slate-700 transition-all hover:scale-[1.03]">
                    Track Promises
                  </Link>
                  <Link to="/rti" className="px-3.5 py-2 bg-slate-100 hover:bg-slate-200 border border-slate-200 hover:border-slate-300 text-xs font-semibold rounded text-slate-700 transition-all hover:scale-[1.03]">
                    Report an Issue
                  </Link>
                </div>
              </div>
